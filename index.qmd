...
gap_map <- left_join(country_shapes, gap07, 
...
value_box(
  ...
  theme = value_box_theme(bg = "#5d52bf"),
...
value_box(
  ...
  theme = value_box_theme(bg = "#342f61"),
...
value_box(
  ...
  theme = value_box_theme(bg = "#4f4794")
)
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/hVimVzgtD6w?si=t6QbrgpGTkP7PlIJ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>